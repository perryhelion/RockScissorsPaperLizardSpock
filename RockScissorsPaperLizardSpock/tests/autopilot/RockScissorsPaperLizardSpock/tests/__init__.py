...
import RockScissorsPaperLizardSpock
...
class BaseTestCase(AutopilotTestCase):
    ...
    click_package = '{0}.{1}'.format('RockScissorsPaperLizardSpock', 'phelion')

    def setUp(self):
        super(BaseTestCase, self).setUp()
        self.launcher, self.test_type = self.get_launcher_and_type()
        self.app = RockScissorsPaperLizardSpock.TouchApp(self.launcher(), self.test_type)
