...
SUBDIRS += RockScissorsPaperLizardSpock
...
UBUNTU_TRANSLATION_DOMAIN="rockscissorspaperlizardspock.phelion"
...
aptest.commands = bash $$PWD/RockScissorsPaperLizardSpock/tests/autopilot/run
aptest.depends  = sub-RockScissorsPaperLizardSpock

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/RockScissorsPaperLizardSpock/tests/unit
unittest.depends  = sub-RockScissorsPaperLizardSpock
